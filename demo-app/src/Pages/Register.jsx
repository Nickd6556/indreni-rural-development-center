...
const Register = () => {
  return (
   ...
   validationSchema={Yup.object({
    ...
    .max(15,'First Name must have less than or equal to 15 character'),

   lname:Yup.string()
    .required("Last Name Is Mandatory")
    .max(15,'Last Name must have less than or equal to 15 character'),
    ...
    .matches(/^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[\@\#\$\_])[a-zA-Z0-9\@\#\$\?].{8,32}$/,'Password must be more than 8 characters and must have Uppercase ,Lowercase ,a Special Character and a number'),
